...
d = { 'settings': { 'branch': 'main',
                ...
                'lib_path': 'finsets'},
  'syms': { 'finsets.wrds_compa': { 'finsets.wrds_compa.clean': ('wrds_compa.html#clean', 'finsets/wrds_compa.py'),
                                    'finsets.wrds_compa.common_raw_vars': ('wrds_compa.html#common_raw_vars', 'finsets/wrds_compa.py'),
            ...
            'finsets.wrds_links': { 'finsets.wrds_links.gvkey_permno': ('wrds_links.html#gvkey_permno', 'finsets/wrds_links.py'),
                                    'finsets.wrds_links.merge_permno_into_gvkey': ( 'wrds_links.html#merge_permno_into_gvkey',
                                                                                    'finsets/wrds_links.py')},
