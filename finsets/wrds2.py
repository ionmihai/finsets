# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/wrds2.ipynb.

# %% auto 0
__all__ = ['version_info', 'appname', 'WRDS_POSTGRES_HOST', 'WRDS_POSTGRES_PORT', 'WRDS_POSTGRES_DB', 'WRDS_CONNECT_ARGS',
           'NotSubscribedError', 'SchemaNotFoundError', 'Connection']
